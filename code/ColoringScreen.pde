...
class ColoringScreen {
  ...
  ColoringScreen(PImage outline) {
    ...
    generateColorButton = new Button((int)redBox.x, 300, blueBox.x - redBox.x + blueBox.w, 40, "Generate");
  ...
  void display() {
    ...
    fill(0);
    text("Mouse X : " + mouseX, eraserButton.x + eraserButton.w + 20, eraserButton.y + 30);
    text("Mouse Y : " + mouseY, eraserButton.x + eraserButton.w + 150, eraserButton.y + 30);
